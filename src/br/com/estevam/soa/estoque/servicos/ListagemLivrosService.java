 ...
 * 
 */
@WebServiceClient(name = "ListagemLivrosService", targetNamespace = "http://servicos.estoque.soa.estevam.com.br/", wsdlLocation = "http://localhost:8080/livros?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LISTAGEMLIVROSSERVICE_QNAME = new QName("http://servicos.estoque.soa.estevam.com.br/", "ListagemLivrosService");
    ...
    public ListagemLivros getListagemLivrosPort() {
        return super.getPort(new QName("http://servicos.estoque.soa.estevam.com.br/", "ListagemLivrosPort"), ListagemLivros.class);
    }
    ...
    public ListagemLivros getListagemLivrosPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicos.estoque.soa.estevam.com.br/", "ListagemLivrosPort"), ListagemLivros.class, features);
    }
